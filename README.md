...
See [SETUP.md](SETUP.md) for full environment setup, script inventory, dependencies, and configuration details.
...
For full step-by-step workflow runbooks and script inventory see [WORKFLOWS.md](WORKFLOWS.md).
