...
from azure.mgmt.compute.models import (
    ...
    OSDisk, ManagedDiskParameters, OSProfile, NetworkProfile,
...
"""
        ...
        print("[*] Tearing down VM and network resources...")
        compute_client.virtual_machines.begin_delete(RESOURCE_GROUP, "vm-health-check").result()
        print("[+] VM deleted")
        network_client.network_interfaces.begin_delete(RESOURCE_GROUP, "nic-health-vm").result()
        print("[+] NIC deleted")
        network_client.public_ip_addresses.begin_delete(RESOURCE_GROUP, "ip-health-vm").result()
        print("[+] Public IP deleted")
        network_client.virtual_networks.begin_delete(RESOURCE_GROUP, "vnet-health").result()
